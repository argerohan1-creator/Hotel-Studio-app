...
for i, line in enumerate(lines):
    if 'val dietFilter by viewModel.recipePickerDiet.collectAsState()' in line:
        start_idx = i
    if start_idx != -1 and 'matchesSearch && matchesCategory && matchesDiet' in line:
        end_idx = i
        break

if start_idx != -1 and end_idx != -1:
    replacement = """    val dietFilter by viewModel.recipePickerDiet.collectAsState()
